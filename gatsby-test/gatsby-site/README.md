...
Build with [https://www.gatsbyjs.org/](https://www.gatsbyjs.org/) and taking advantage of `gatsby-transformer-sharp`, this app stores _only_ the data it needs to run as a static JSON file.
...
What this means for us is a super responsive filter & comparison tool that doesn't force us to hammer the E7 API for data we don't need/use.
